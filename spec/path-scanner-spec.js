...
describe("PathScanner", function() {
  ...
  describe("a non-git directory with many files", function() {
    ...
    describe("including file paths", function() {
      ...
      dirs.forEach((dir) => {
        it(`lists only paths specified in ${dir}`, function() {
          let finishedHandler, pathHandler;
    ...
    describe("excluding file paths", function() {
  ...
  describe("with a git repo", function() {
    ...
    it("correctly ignores files when searching a subdirectory when excludeVcsIgnores is true", function() {
      let finishedHandler, pathHandler;
