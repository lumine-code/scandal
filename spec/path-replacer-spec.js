...
`.replace(/\n/g, os.EOL);
    ...
    describe("when the file has different permissions than temp files", function() {
      ...
      it("replaces and keeps the same file modes", function() {
        let finishedHandler;
    ...
    describe("when a file doesnt exist", () => it("calls the done callback with a list of errors", function() {
      let finishedHandler, resultsHandler;
      replacer.on('path-replaced', (resultsHandler = jasmine.createSpy()));
